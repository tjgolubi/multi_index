...
public:
  ...
  {
    if (!p)
      throw std::runtime_error("null indirection");
  ...
  non_raw_pointer& operator++()
  {
    ++p;
    return *this;
  }
  non_raw_pointer operator++(int)
  {
    non_raw_pointer t(*this);
    ++p;
    return t;
  }
  non_raw_pointer& operator--()
  ...
  non_raw_pointer& operator+=(std::ptrdiff_t n)
  {
    p += n;
    return *this;
  }
...
public:
  ...
  template<class U>struct rebind {
    typedef non_std_allocator<U> other;
  };
