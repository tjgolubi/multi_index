...
struct base {
  ...
  int       cnef() const noexcept
  {
    return x;
  };
  int       vnef()volatile noexcept
  {
    return x;
  };
  int       cvnef() const volatile noexcept
  {
    return x;
  };
  int       rnef()& noexcept{return x;};
  int       crnef() const& noexcept
  {
    return x;
  };
  int       vrnef()volatile& noexcept
  {
    return x;
  };
  int       cvrnef() const volatile& noexcept
  {
    return x;
  };
};
...
int negf(const base& b) noexcept
{
  return b.x;
}
...
int grh(std::reference_wrapper<derived>& d)
{
  return d.get().y;
}
