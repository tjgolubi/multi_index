...
struct index_policy_base {
  ...
  static index_type& index_from_container(container& c)
  {
    return get<N>(c);
  }
};
...
struct employee_set_policy_base {
  static employee    some_value()
  {
    return employee(0, "Joe", 31, 1123);
  }
  static employee    another_value()
  {
    return employee(1, "Robert", 27, 5601);
  }
};
